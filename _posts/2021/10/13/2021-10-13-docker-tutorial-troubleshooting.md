...
Well, at least I was getting _some_ response. Since this was a newly installed container, I expected it to just work. Also, since I was accessing the container through a standard web browser, I didn't expect the request header or the cookies to be too large.
