...
I like how the installation looks. It has a very simple and clean interface. I can't wait until the installation is finished so that I can start using it! I may have fudged a bit on the install (I choose to install _everything_). But, I figure that I can always just re-install and start again if I need to.
